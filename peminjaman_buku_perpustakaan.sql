...
DROP DATABASE IF EXISTS `perpustakaan_dtei`;
...
DROP TABLE IF EXISTS `buku_akhir`;
...
DROP PROCEDURE IF EXISTS `delete_buku_akhir`;
DELIMITER //
...
INSERT IGNORE INTO `detail_peminjaman` (`id_detail`, `fk_peminjaman`, `fk_buku`) VALUES
	('DP250012', 'P250019', 'B250001'),
	('DP250013', 'P250019', 'B250001');
...
CREATE TABLE IF NOT EXISTS `peminjaman` (
  ...
  `tanggal_disetor` datetime DEFAULT NULL,
...
DROP PROCEDURE IF EXISTS `setor_buku_akhir`;
DELIMITER //
...
-- Dumping structure for procedure perpustakaan_dtei.status_to_terlambat
DROP PROCEDURE IF EXISTS `status_to_terlambat`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `update_buku_akhir`;
DELIMITER //
...
DROP VIEW IF EXISTS `view_buku_akhir`;
-- Creating temporary table to overcome VIEW dependency errors
...
DROP VIEW IF EXISTS `view_detail_peminjaman`;
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `view_detail_peminjaman` (
	`id_detail` CHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci',
	`fk_peminjaman` CHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci',
	`nama_buku` VARCHAR(50) NOT NULL COLLATE 'utf8mb4_general_ci'
) ENGINE=MyISAM;
...
DROP TRIGGER IF EXISTS `before_insert_detail_peminjaman`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `before_insert_jenis_buku`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `before_insert_peminjaman`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `before_insert_penerbit`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `before_insert_penulis`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `before_insert_sumber`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `view_detail_peminjaman` AS SELECT dp.id_detail, dp.fk_peminjaman, b.nama_buku
